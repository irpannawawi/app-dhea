...
use App\Http\Controllers\MavController;
...
Route::post('/BarangKeluar/update', [SPB_Controller::class, 'store  ']);
...
Route::post('/tambahBarang/store', [BarangController :: class, 'tambahBarangStore']);


Route::get('/MovingAvg/{id}', [MovingAvgController :: class, 'ShowMovingAvg','JualPerBulan']);
Route::get('periode/{SKU}', [MovingAvgController :: class, 'periode']);

// Report
Route::get('report', [MavController::class, 'report'])->name('Report');
Route::get('print_report', [MavController::class, 'print_report'])->name('print_report');
