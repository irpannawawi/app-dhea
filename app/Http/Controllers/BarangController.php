...
class BarangController extends Controller
{
    ...
    public function BarangKeluar(Request $request)
    {
        ...
        INSERT INTO `barang_keluar`(`nama_barang`,`SKU`, `keterangan`, `qty`, `harga_satuan`, `jumlah`) VALUES 
        ('$request->nama_barang', '$request->SKU', '$request->keterangan','".(int)$request->qty."','".(int)$request->harga_satuan."','".(int)$request->jumlah."');
